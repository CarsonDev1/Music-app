...
import { BsFillSunFill, BsFillMoonStarsFill } from "react-icon/bs";
...
const Header = () => {
  ...
  return (
    <header className="flex items-center w-full p-4 md:py-2 md:px-6">
      ...
      <button onClick={toggleDarkMode} className="bg-red-500 w-[4]">
        Mode
      </button>
      <div
        className="flex items-center ml-auto cursor-pointer gap-2 dark:bg-black bg-white relative"
